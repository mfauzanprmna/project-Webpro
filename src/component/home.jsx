        ...
        <>
            ...
            <div className='xl:container xl:mx-auto px-5 flex flex-wrap-reverse marquee items-center w-full h-[45rem]'>
                <div className='Poppins-medium flex-auto sm:w-[10rem] mr-5'>
                    <h1 className='text-white text-opacity-75 lg:text-6xl text-start font-bold bg-slate-600 rounded-t-lg p-3 text-3xl sm:text-4xl mr-[0%]'>WELCOME MESSAGE</h1>
                    <p className='text-black text-justify border-4 border-t-2 p-4 rounded-b shadow-lg sm:text-lg text-sm'>
            ...
            <div className='xl:container xl:mx-auto px-5 flex flex-wrap marquee1 items-center w-full h-[45rem]'>
                ...
                <div className='Poppins-medium flex-auto sm:w-[10rem]'>
                    <h1 className='text-white text-opacity-75 lg:text-6xl font-bold bg-slate-600 rounded-t-lg border-r text-center ml-[0%] p-3 sm:text-4xl text-3xl'>ABOUT US</h1>
                    <p className='text-black border-4 border-t-2 py-10 text-justify px-3 h-60 rounded-b shadow-lg'>
            ...
            <div className='xl:container xl:mx-auto px-5 flex flex-wrap marquee items-center py-10 gap-4 w-full lg:h-screen mb-10'>
                <div className='Poppins-medium flex-auto lg:w-[10rem] mr-5'>
                    <h1 className='text-white text-opacity-75 lg:text-6xl text-center font-bold bg-slate-600 rounded-t-lg p-3 text-3xl sm:text-4xl mr-[0%]'>VISI</h1>
                    <p className='text-black text-justify border-4 border-t-2 rounded-b px-5 py-20 h-96 shadow-lg sm:text-lg text-sm'>
                        <b>Our vision</b> <br />
                ...
                <div className='Poppins-medium flex-auto lg:w-[10rem] mr-5'>
                    <h1 className='text-white text-opacity-75 lg:text-6xl text-center font-bold bg-slate-600 rounded-t-lg p-3 text-3xl sm:text-4xl ml-[0%]'>MISI</h1>
                    <p className='text-black text-justify border-4 border-t-2 rounded-b p-5 h-96 shadow-lg sm:text-lg text-sm'>
                        <b> Our mission</b> <br />
